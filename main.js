      ...
      <section id="projects" class="projects-section section-padding">
        <div class="container">
          ...
          <div class="filter-tabs" data-aos="fade-up">
            ...
            <button class="filter-btn" data-filter="react">React / AI</button>
            <button class="filter-btn" data-filter="mern">MERN Stack</button>
            <button class="filter-btn" data-filter="cricket">Cricket Analytics</button>
          </div>

          <div class="projects-grid">
            <!-- Project 1 -->
            <div class="project-card tilt-card" data-aos="fade-up" data-aos-delay="100" data-category="react">
              <div class="project-img">
                <img src="https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=800" alt="AI Virtual Assistant">
                <div class="project-overlay">
                  <div class="project-tags"><span>React</span><span>Gemini API</span></div>
                  <div class="project-links">
                    <a href="https://github.com/Princeturkar/AI-virtual-Assistant-" target="_blank"><i class="fa-brands fa-github"></i></a>
                  </div>
                </div>
              </div>
              <div class="project-info">
                <h3>AI Virtual Assistant</h3>
                <p>Intelligent assistant built with React and Gemini API for natural language interactions.</p>
              </div>
            </div>
            <!-- Project 2 -->
            <div class="project-card tilt-card" data-aos="fade-up" data-aos-delay="200" data-category="mern">
              <div class="project-img">
                <img src="https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&q=80&w=800" alt="Job Portal">
                <div class="project-overlay">
                  <div class="project-tags"><span>MERN Stack</span><span>Auth</span></div>
                  <div class="project-links">
                    <a href="https://github.com/Princeturkar/Job-portal" target="_blank"><i class="fa-brands fa-github"></i></a>
                  </div>
                </div>
              </div>
              <div class="project-info">
                <h3>Job Portal</h3>
                <p>Streamlined job search and application platform using the full MERN stack capabilities.</p>
              </div>
            </div>
            <!-- Project 3 -->
            <div class="project-card tilt-card" data-aos="fade-up" data-aos-delay="300" data-category="cricket">
              <div class="project-img">
                <img src="https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&q=80&w=800" alt="Cricket Stats">
                <div class="project-overlay">
                  <div class="project-tags"><span>MERN</span><span>Groq API</span></div>
                  <div class="project-links">
                    <a href="https://github.com/Princeturkar/cricket-stats" target="_blank"><i class="fa-brands fa-github"></i></a>
                  </div>
                </div>
              </div>
              <div class="project-info">
                <h3>Cricket Stats</h3>
                <p>Advanced cricket analytics platform with live data and AI-powered insights.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="certificates-grid">
            <div class="cert-card" data-aos="fade-up" data-aos-delay="100">
              ...
              <p>Completed AWS Solutions Architecture Job Simulation, focusing on scalable and reliable cloud infrastructure.</p>
            ...
            <div class="cert-card" data-aos="fade-up" data-aos-delay="200">
              <div class="cert-icon"><i class="fa-solid fa-robot"></i></div>
              <h3>ChatGPT & Generative AI</h3>
              <p>Specialized certification in Generative AI and Prompt Engineering for building intelligent applications.</p>
              <a href="#" class="cert-link" target="_blank" rel="noopener noreferrer">View Certificate <i class="fa-solid fa-arrow-right"></i></a>
            </div>
